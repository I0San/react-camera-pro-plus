...
var CameraComponent = function (_a, ref) {
    ...
    var _q = React.useState(false), isRecording = _q[0], setIsRecording = _q[1];
    var _r = React.useState([]), recordedChunks = _r[0], setRecordedChunks = _r[1];
    ...
    return (React__default.createElement(Container, { ref: container, aspectRatios: aspectRatio },
...
var Camera = React__default.forwardRef(CameraComponent);
